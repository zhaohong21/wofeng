...
if(isset($_POST['keyword'])){
    ...
    if ($keyword != '') {
        queryMysql("INSERT INTO question_group(group_name,keyword) VALUES ('$group_name','$keyword')");
            ...
            <div class="col-md-12">
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">服务问题组新建</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal problem_form" action="./createProblemGroup" method="post">
                  <div class="box-body">

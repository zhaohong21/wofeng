...
if (isset($_POST['id'])) {
    ...
    if ($name != '') {
        if(queryMysql("UPDATE question SET name='$name',type_id='$type_id',type_name='$type_name',answer='$answer' WHERE id=$id"))
            $result = true;
        else $result = false;
...
if (isset($_GET['id']))
{
    ...
    if ($row = queryMysql("SELECT * FROM question WHERE id=$id")) {
        if ($row->num_rows)
        {
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-info">
                        ...
                        <div class="form-horizontal">
                            <form class="box-body problem_form" action="./editProblem">
                                <?php
                                echo <<<_END
<input class="problem_id" type="text" value="$id" style="display: none;">
_END;
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control name" id="q_name" value="<?php echo $name; ?>" placeholder="Question Name">
                                    </div>
                                </div>
                                <div class="form-group">
